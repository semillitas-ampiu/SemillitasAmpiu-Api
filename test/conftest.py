...
def jugador_data(timestamp):
    ...
    return {"username": f"jugador_test_{timestamp}", "fecha_nacimiento": "2010-05-15"}
...
@pytest.fixture
def palabra_data(timestamp):
    """Datos para crear una palabra de prueba"""
    return {"pal_español": f"español_{timestamp}", "pal_ampiu": f"ampiu_{timestamp}"}
