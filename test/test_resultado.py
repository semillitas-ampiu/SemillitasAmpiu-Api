...
class TestResultadoList:
    ...
    def test_RE02_crear_resultado_completo(self, crear_jugador, crear_evaluacion):
        """RE02: Crear resultado con todos los campos retorna 201"""
        resultado_data = {
            "evaluacion": crear_evaluacion["id"],
    ...
    def test_RE03_crear_resultado_valores_por_defecto(self, crear_jugador, crear_evaluacion):
    ...
    def test_RE04_crear_resultado_evaluacion_inexistente(self, crear_jugador):
        """RE04: Crear resultado con evaluacion inexistente retorna 400"""
        resultado_data = {
            "evaluacion": 99999,
            "usuario": crear_jugador["id"],
            "puntaje": 50
    ...
    def test_RE05_crear_resultado_usuario_inexistente(self, crear_evaluacion):
        """RE05: Crear resultado con usuario inexistente retorna 400"""
        resultado_data = {
            "evaluacion": crear_evaluacion["id"],
            "usuario": 99999,
            "puntaje": 50
...
class TestResultadoDetail:
    ...
    def test_RE06_obtener_resultado_por_id_valido(self, crear_jugador, crear_evaluacion):
    ...
    def test_RE09_actualizar_resultado(self, crear_jugador, crear_evaluacion):
        """RE09: PUT /resultado/<id> actualiza puntaje y completado"""
        # Crear resultado
        resultado_data = {
            "evaluacion": crear_evaluacion["id"],
            "usuario": crear_jugador["id"],
        ...
        response = requests.put(f"{BASE_URL}/resultado/{resultado_id}", json=updated_data)
        
        assert response.status_code == 200
        assert response.json()["puntaje"] == 100
        assert response.json()["completado"] == True
    
    def test_RE10_eliminar_resultado(self, crear_jugador, crear_evaluacion):
...
class TestResultadoFiltros:
    ...
    def test_RE08_filtrar_por_usuario(self, crear_jugador, crear_evaluacion):
